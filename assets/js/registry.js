...
window.TOOLS = [
  ...
  },
  {
    ...
    img: "assets/img/tool-art/lootbox.webp",
    cat: "misc",
    name: "Item Value Finder",
    desc: "Pick what you're after — troops, sceats, construction & upgrade tokens, gems, decos, event currency — and see which in-game shop packages give the most per token.",
    icon: "🎁",
    status: "live",
    url: "tools/item-value/",
    tags: ["item", "value", "packages", "shop", "tokens", "sceats", "construction", "upgrade", "troops", "gems", "event", "vendor", "best value"],
  },
  {
    slug: "upgrade-cost",
    img: "assets/img/tool-art/reinforced-vault.webp",
